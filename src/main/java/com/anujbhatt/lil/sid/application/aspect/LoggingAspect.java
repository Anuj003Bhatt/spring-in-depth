package com.anujbhatt.lil.sid.application.aspect;
...
public class LoggingAspect {
    ...
    public void logMethodCall(JoinPoint jointPoint, Object returnValue){
        StringBuilder message = new StringBuilder("After returning Method: ");
        message.append(jointPoint.getSignature().getName());
        Object[] args = jointPoint.getArgs();
        if (null != args && args.length>0) {
            message.append("args=[ | ");
